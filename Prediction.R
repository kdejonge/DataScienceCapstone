...
twitter_predict <- function(x) {
  ...
  # load dataset
  twitter_lookup <- read.csv(file = "D:/OneDrive - Esri Nederland/Kristin de Jonge/Studie/DataScience/Data Science Specialization/Course10/Coursera-SwiftKey/final/en_US/twitter_lookup.csv",stringsAsFactors = FALSE)
...
blogs_predict <- function(x) {
  # load dataset
  blogs_lookup <- read.csv(file = "D:/OneDrive - Esri Nederland/Kristin de Jonge/Studie/DataScience/Data Science Specialization/Course10/Coursera-SwiftKey/final/en_US/blogs_lookup.csv",stringsAsFactors = FALSE)
...
news_predict <- function(x) {
  # load dataset
  news_lookup <- read.csv(file = "D:/OneDrive - Esri Nederland/Kristin de Jonge/Studie/DataScience/Data Science Specialization/Course10/Coursera-SwiftKey/final/en_US/news_lookup.csv",stringsAsFactors = FALSE)
